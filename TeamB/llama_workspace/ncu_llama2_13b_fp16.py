"""
ncu_llama2_13b_fp16.py — Llama-2 7B FP16 for ncu profiling (prefill, seq=128)

Usage:
    ncu -o results/ncu/llama2_13b_fp16 \
...
gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed \
        ...
        --force-overwrite \
        python ncu_llama2_13b_fp16.py

    ncu --import results/ncu/llama2_13b_fp16.ncu-rep \
        --csv --print-units base 2>/dev/null \
        > results/ncu/llama2_13b_fp16_metrics.csv
"""
import os, time
import torch
