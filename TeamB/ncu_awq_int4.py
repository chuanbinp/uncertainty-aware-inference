"""
ncu_awq_int4.py — Mistral-7B AWQ INT4 for ncu profiling (prefill, seq=128)

Usage:
    # Profile:
    ncu -o results/ncu/mistral_awq_int4 \
...
gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed \
        ...
        --kernel-name "regex:awq_gemm|fmha_cutlass" \
        --force-overwrite \
        python ncu_awq_int4.py

    # Extract CSV:
    ncu --import results/ncu/mistral_awq_int4.ncu-rep \
        --csv --print-units base 2>/dev/null \
        > results/ncu/mistral_awq_int4_metrics.csv
"""
import os, time
import torch
